    ...
    >
      ...
      {props.type === ConfirmationType.RevertEntity && (
        <>
          ...
          <p>The settings from the last saved version of all properties of will be restored.</p>
        </>
      )}

      {props.type === ConfirmationType.RevertAll && (
        <>
          <p id="revert-all-text">Are you sure you want to discard all changes to entity types?</p>
